...
export default function ColumnGroupingTable({ data,setPageReload}) {
  ...
  <Modal
        ...
        <div style={{ "textAlign": "center" }}>
          ...
          {block?<><span> are you sure you want to block the user?</span><br /><br />
            <button style={{}} onClick={async () => {
              ...
              setPageReload((prev)=>!prev)
                    ...
                    }}>{loading?"loading":"block"}</button></>:<><span> are you sure you want to  unblock the user?</span><br /><br />
              <button style={{}} onClick={async () => {
                setLoading(true)
                      ...
                      return (
                        <TableCell key={column.id} align={column.align}>
                          {/* {column.format && typeof value === 'number'
                            ...
                            : value}
                             */}
                          {value ? value : row.block ?<button onClick={() => {
                            setBlock(false)
                            setUserId(row._id)
                            setOpened(true);
